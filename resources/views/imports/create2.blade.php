...
@section('title', 'Create new Import sheet')
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
            <div class="row">
                    ...
                    <div class="aka-box aka-box--large aka-select">
                        <div class="document-contact-without-contact-box">
                            <button type="button" class="btn-aka-link aka-btn--fluid document-contact-without-contact-box-btn" data-toggle="modal" data-target="#billModal">
                                <i class="far fa-clipboard fa-2x"></i> &nbsp; Choose from bills
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div id="info{{ $jb->billID }}" class="ml-3 billDiv" style="display: none">
                    <div class="table-responsive">
                        <table class="table table-borderless p-0">
                            <tbody>
                                <tr>
                                    <th class="p-0" style="text-align: center;font-size: 2rem"><strong class="d-block aka-text">Bill N.o {{ $jb->billID }}</strong></th>
                                </tr>
                                <tr>
                                    <th class="p-0" style="text-align: left; white-space: normal;font-size: 1.2rem">
                                        <span style="font-weight: bold">Vendor: </span>{{ $jb->vendorName }}
                                    </th>
                                </tr>
                                <tr>
                                    <th class="p-0" style="text-align: left;font-size: 1.2rem">
                                        Bill date: {{ $jb->billDate }}
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table id="" class="display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $jb->billDate }}</td>
                                    <td>
                                        <button type="button" class="btn btn-primary" id="bill{{ $jb->billID }}">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
            <div class="row mb-4 mt-4 mr-2">
                ...
                {{-- Import Number  --}}
                <div class="form-group col-md-6 required">
                    <label for="document_number" class="form-control-label">Import Number</label>
                    <div class="input-group input-group-merge ">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
