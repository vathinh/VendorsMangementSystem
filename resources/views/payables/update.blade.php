...
@section('title', 'Update a Payable')
@section('content')
@php
                ...
                <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-merge ">
                                    ...
                                    <input type="date" class="form-control" name="paybleDate" id="payableDate">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-merge ">
                                    ...
                                    <input type="number" class="form-control" name="total"id="total" value="100000" >
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                                ...
                                                <tr id="a">
                                                    ...
                                                    <td class="align-middle px-1">
                                                        <div class="input-group">
                                                            <input class="form-control text-right" name="price1" id="price1"/>
                                                    ...
                                                    <td class="align-middle px-1">
                                                        <div class="input-group">
                                                            <input class="form-control text-right" type="number" name="amount1" id="amount1" value="10000"/>
                                                        ...
                                                        <div id="select-item-button-9" class="product-select">
                                                            <div class="item-add-new">
                                                                <button type="button" class="btn btn-link w-100">
                                                                    <i class="fas fa-plus-circle"></i> &nbsp; Add a Bill
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </td>
                    ...
                    <div class="card-footer">
                        <div class="row save-buttons">
                            <div class="col-md-12">
                                <a  href="/payables/index" class="btn btn-icon btn-primary">Cancel</a>
