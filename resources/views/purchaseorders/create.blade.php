...
@php
    ...
    if(isset($isUpdate) && old('tableRow') == null){
        //Purchase Order
        $orderID = $purchaseorders->purchaseorderID;
        $vendorID = $purchaseorders->vendorID;
        $dt = new DateTime($purchaseorders->purchaseorderDate);

        $orderDate = $dt->format('Y-m-d');

        $desc = $purchaseorders->description;
        $tableRow = count($details);
        //Details
        foreach ($details as $details) {
            $detailID[] = $details->purchaseorderdetailsID;
        ...
        $orderDate = old('purchaseorderDate',date("Y-m-d"));
        $desc = old('desc');
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table id="vendorTable" class="table table-hover table-striped" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Vendor Name</th>
                                                <th>Tax Number</th>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                        <div class="row mb-7">
                            ...
                            <div class="form-group col-md-6">
                                <label for="document_number" class="form-control-label">Purchase Order Date</label>
                                <div class="input-group input-group-merge ">
                                    ...
                                    <input type="date" class="form-control" name="purchaseorderDate"
                                        value="{{ $orderDate }}">
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header pb-0">
                                <h5 class="modal-title" style="font-size: 20px">Product List</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body pt-0">
                                <table id="productTable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 40%; white-space: normal;">{{ $product->productName }}</td>
                                            <td>{{ $product->manufacture }}</td>
                                            <td>{{ $product->quantity }}</td>
                                            <td>${{ $product->purchaseprice }}</td>
                                            <input type="hidden" id="purchaseprice{{ $product->productID }}"
                                        ...
                                        <script>
                                            ...
                                            $("#product{{ $product->productID }}").click(function(e) {
                                                $(".chosing").closest("tr").find("input[id=price]").val($('#purchaseprice{{ $product->productID }}').val());
        ...
        <div class="card">
            <div class="card-footer">
                <div class="row save-buttons">
                    <div class="col-md-12">
                        <a href="/purchaseorders/index" class="btn btn-success">Cancel</a>
                        @if(!isset($isUpdate) || $isUpdate != "Show")
